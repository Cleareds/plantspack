...
export const veganVsVegetarianArticle: IngredientArticle = {
  ...
  searchQueries: [
    ...
    'is vegan harder than vegetarian',
  ...
  faq: [
    {
      question: 'Can vegetarians eat eggs and dairy?',
      answer: 'Yes. The most common form of vegetarianism, lacto-ovo, includes both eggs and dairy. Lacto vegetarian includes dairy but not eggs. Ovo vegetarian includes eggs but not dairy. If a menu just says "vegetarian," assume eggs and dairy are in scope.',
    },
    {
      question: 'Is pescatarian the same as vegetarian?',
      answer: 'No. Pescatarians eat fish and shellfish, which most definitions of vegetarianism exclude. The label is sometimes used as a stepping stone toward vegetarianism, but it is technically a separate category.',
    },
    {
      question: 'Is plant-based the same as vegan?',
      answer: 'Overlapping but not identical. Plant-based usually refers to the diet only - no animal products in food. Vegan is broader, covering clothing, household products, and an ethical stance on animal use generally. A plant-based packaged food is functionally vegan; a "plant-based person" may or may not avoid leather and wool.',
    },
    {
      question: 'Why do some vegetarians go vegan?',
      answer: 'Most do it after learning that the dairy and egg industries kill animals at scale even without serving meat - male calves are culled in dairy, male chicks are culled in egg production, and dairy cows and laying hens are slaughtered once productivity drops. For people whose vegetarianism is ethically motivated, this reasoning often pushes them further.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Both can be. The Academy of Nutrition and Dietetics (2016) endorses well-planned vegetarian and vegan diets as nutritionally adequate at all life stages. Vegans need to take B12; both groups benefit from tracking iron, calcium, omega-3, iodine, and vitamin D.',
    },
  ],
  relatedTools: ['ingredient-scanner', 'cards', 'barcode'],
  relatedTopics: ['honey', 'vitamins', 'cheese'],
  sources: [
    { title: 'The Vegan Society: definition of veganism', url: 'https://www.vegansociety.com/go-vegan/definition-veganism' },
    { title: 'Academy of Nutrition and Dietetics (2016) Position Paper on Vegetarian Diets', url: 'https://www.jandonline.org/article/S2212-2672(16)31192-3/fulltext' },
    { title: 'PETA: The dairy and egg industries', url: 'https://www.peta.org/issues/animals-used-for-food/factory-farming/cows/dairy-industry/' },
  ],

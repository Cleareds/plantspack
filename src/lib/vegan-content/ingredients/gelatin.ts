...
export const gelatinArticle: IngredientArticle = {
  ...
  searchQueries: [
    ...
    'is yogurt with gelatin vegan',
    'is collagen vegan',
  ],
  verdict: 'usually-no',
  verdictHeadline: 'No. Gelatin is made from boiled animal bones, skin and connective tissue (usually pig or cow). It is never vegan.',
  ...
  faq: [
    {
      ...
      answer: 'Gelatin is collagen protein extracted by boiling animal skin, bone and connective tissue. Most commercial gelatin comes from pig skin and cow hide, with a smaller share from fish skin and scales. It is a slaughterhouse byproduct in every case.',
    },
    {
      question: 'Are marshmallows ever vegan?',
      answer: 'Yes, but not the standard ones. Traditional marshmallows are mostly sugar and gelatin. Dandies (US and UK) and Freedom Mallows (UK) make vegan marshmallows using carrageenan or other plant gelling agents, and they toast and melt the same way. Check the bag because some "fluffy" mallows still use gelatin.',
    },
    {
      question: 'Is jello vegan?',
      answer: 'Traditional Jell-O and supermarket jelly are not vegan because they use gelatin. You can make the same dessert at home with agar agar and fruit juice, and several brands sell pre-made vegan jelly mixes. In the UK look for Just Wholefoods vegan jelly crystals.',
    },
    {
      question: 'Are gummy vitamins vegan?',
      answer: 'Most gummy vitamins use gelatin, so usually no. Pectin-based vegan gummy vitamins do exist from brands like Hum Nutrition, MaryRuth\'s, Llama Naturals and Ritual. The label will say pectin in the ingredients and often "vegan" on the front.',
    },
    {
      question: 'Is fish gelatin vegan?',
      answer: 'No. Fish gelatin is made from fish skin and scales, which makes it an animal product. It is sometimes marketed at pescatarians or as a kosher alternative, but it is not vegan and not vegetarian by strict definitions.',
    },
    {
      question: 'What about gel capsules in supplements and medication?',
  ...
  sources: [
    ...
    { title: 'FDA: Gelatin Capsules and CFR food additive listing', url: 'https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfcfr/CFRSearch.cfm?fr=184.1318' },
    { title: 'PETA: What is gelatin made of?', url: 'https://www.peta.org/about-peta/faq/what-is-gelatin-made-of/' },
  ],

...
export default function BottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 w-full z-40 flex justify-around items-end px-4 pb-[env(safe-area-inset-bottom,8px)] h-20 bg-surface/90 backdrop-blur-xl shadow-[0_-10px_40px_rgba(45,47,44,0.06)]">
      {navItems.map((item) => {

          ...
          <div className="bg-surface-container-lowest rounded-2xl max-w-lg w-full max-h-[80vh] overflow-y-auto p-6" onClick={e => e.stopPropagation()}>
            ...
            <div className="bg-surface-container-low rounded-xl p-3 mb-4">
              ...
              <div className="grid grid-cols-3 gap-2 text-xs">
                ...
                <div><span className="font-bold text-green-500">B+</span> <span className="text-on-surface-variant">70-77</span></div>
                <div><span className="font-bold text-green-500">B</span> <span className="text-on-surface-variant">62-69</span></div>
                <div><span className="font-bold text-yellow-500">C+</span> <span className="text-on-surface-variant">54-61</span></div>
                <div><span className="font-bold text-yellow-500">C</span> <span className="text-on-surface-variant">45-53</span></div>
                <div><span className="font-bold text-orange-500">D+</span> <span className="text-on-surface-variant">37-44</span></div>
                <div><span className="font-bold text-orange-500">D</span> <span className="text-on-surface-variant">30-36</span></div>

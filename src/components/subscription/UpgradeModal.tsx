...
export default function UpgradeModal({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-surface-container-lowest rounded-lg shadow-ambient max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-outline-variant/15">
          <div className="flex items-center space-x-3">
            <Crown className="h-6 w-6 text-primary" />
            <h2 className="text-xl font-semibold text-on-surface">Upgrade Your Plan</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
              ...
              <div
                ...
                className={`border-2 rounded-lg p-4 cursor-pointer transition-colors ${
                  selectedTier === tier.key
                    ...
                    : 'border-outline-variant/15 hover:border-outline-variant/15'
                }`}
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <h3 className="text-lg font-semibold text-on-surface">{tier.name}</h3>
                      <div
                    ...
                    <div className="text-3xl font-bold text-on-surface mb-4">
                      ${tier.price}
                      <span className="text-lg font-normal text-outline">/month</span>
                    </div>
          ...
          {currentTier !== 'free' && (
            <div className="mt-6 bg-surface-container-low rounded-lg p-4">
              <h4 className="font-medium text-on-surface mb-2">What&apos;s changing:</h4>
        ...
        {/* Footer */}
        <div className="flex items-center justify-between p-6 border-t border-outline-variant/15 bg-surface-container-low">
          ...
          <div className="flex items-center space-x-3">
            <button
              onClick={onClose}
              className="px-4 py-2 text-on-surface-variant border border-outline-variant/15 rounded-md hover:bg-surface-container-low transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              disabled={loading}
              className="flex items-center space-x-2 px-6 py-2 silk-gradient hover:opacity-90 text-on-primary rounded-md font-medium transition-colors disabled:opacity-50"
            >

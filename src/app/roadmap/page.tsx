...
const ITEMS: VoteItem[] = [
  ...
  { id: 'tools-scanners', category: 'feature', label: 'AI label & menu scanners', description: 'Photograph an ingredient label or a restaurant menu and get an instant vegan/allergen read — plus drinks, baking and cosmetics checkers.', status: 'shipped', quarter: 'Q2 2026', votable: false },
  { id: 'dish-city-guides', category: 'feature', label: 'Best-vegan-dish city guides', description: '"Best vegan pizza / sushi / brunch in {city}" guides across thousands of cities, so the right vegan spot is one search away.', status: 'shipped', quarter: 'Q3 2026', votable: false },
  { id: 'data-quality-system', category: 'feature', label: 'Verification ladder & data-quality tools', description: 'Confidence tiers, admin review, duplicate detection and a place-correction queue that keep listings accurate.', status: 'shipped', quarter: 'Q2 2026', votable: false },
  ...
  { id: 'mobile-app', category: 'feature', label: 'iOS & Android app', description: 'Native apps — browse the map, save places, suggest new spots. Live on Google Play; on the App Store (business review still pending in some regions).', status: 'shipped', quarter: 'Q3 2026', votable: false },

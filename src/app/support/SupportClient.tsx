...
function SupportContent({ initialStats }: { initialStats: Stats }) {
  const { user } = useAuth()
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="grid grid-cols-3 gap-6 mb-20">
          ...
          <div className="text-center p-6 rounded-[2rem] bg-surface-container-lowest border border-outline-variant/10">
            ...
            <div className="text-3xl font-extrabold text-on-surface tracking-tight">{stats.countries.toLocaleString()}</div>
            <div className="text-sm text-on-surface-variant mt-1">Countries reached</div>
          </div>
          <div className="text-center p-6 rounded-[2rem] bg-surface-container-lowest border border-outline-variant/10">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            >
              ...
              <span className="text-sm text-on-surface-variant text-center">
                {isSupporter ? 'Thank you for your support' : '€3/month · Supporter badge'}
              </span>
            </button>
          </div>
...
export default function SupportClient({ initialStats }: { initialStats: Stats }) {
  return (
    <Suspense fallback={
      ...
      <SupportContent initialStats={initialStats} />
    </Suspense>
  )
}

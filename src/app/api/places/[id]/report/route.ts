...
export async function POST(
  ...
  try {
    ...
    const validTypes = ['confirmed', 'permanently_closed', 'temporarily_closed', 'hours_wrong', 'not_fully_vegan', 'not_vegan_friendly', 'non_vegan_chain', 'vegan_friendly_chain', 'few_vegan_options', 'actually_fully_vegan', 'duplicate']

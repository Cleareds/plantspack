    ...
    <div className="min-h-screen bg-surface py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-surface-container-lowest rounded-lg editorial-shadow ghost-border p-8">
          <h1 className="text-3xl font-bold text-on-surface mb-2">Community Guidelines</h1>
          ...
          <div className="prose prose-green max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">1. Be Kind and Respectful</h2>
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">2. Keep It Drama-Light</h2>
            <p className="text-on-surface-variant mb-4">
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">5. No Hate Speech or Discrimination</h2>
            <p className="text-on-surface-variant mb-4">
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">6. Respect Content Guidelines</h2>
            <p className="text-on-surface-variant mb-4">
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">8. Healthy Debate About Veganism</h2>
            <p className="text-on-surface-variant mb-4">
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">9. Privacy and Safety</h2>
            <p className="text-on-surface-variant mb-4">
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">10. Moderation and Enforcement</h2>
            <p className="text-on-surface-variant mb-4">
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">11. Reporting Violations</h2>
            <p className="text-on-surface-variant mb-4">
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">12. Appeals</h2>
            <p className="text-on-surface-variant mb-4">
            ...
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">Questions?</h2>
            <p className="text-on-surface-variant mb-4">

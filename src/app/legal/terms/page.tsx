        ...
        <div className="bg-surface-container-lowest rounded-lg editorial-shadow ghost-border p-8">
          ...
          <div className="prose prose-green max-w-none">
            ...
            <p className="text-on-surface-variant mb-4">
              ...
              <Link href="/legal/guidelines" className="text-primary hover:text-primary-container underline">
            ...
            <p className="text-on-surface-variant mb-4">
              ...
              <Link href="/legal/privacy" className="text-primary hover:text-primary-container underline">
                Privacy Policy
              </Link>{' '}

...
- banner:
  - link "PlantsPack":
    - /url: /
  - textbox "Search posts and users...": vegan recipe
  - button "Clear search"
  - paragraph: No results found for "vegan recipe"
  - navigation:
    - link "Feed":
      - /url: /
    - link "Map":
...
- main:
  ...
  - paragraph: Failed to load posts. Please try again.
  - button "Try Again"
  - heading "Hello, Friend! 👋" [level=2]
  - paragraph: Share your plant-based animal-friendly journey with the PlantsPack community
  - link "U":
    - /url: /user/undefined
  - textbox "Share your vegan journey...": This is a delicious vegan pasta recipe for testing
  - text: Content Analysis general positive recipe
  - button "Photo"
  - button "Location"

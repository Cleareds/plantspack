...
const payloads = JSON.parse(readFileSync('scripts/seo-out/coverage-boost-2026-05-15/payloads.json','utf8'))
const log = 'scripts/seo-out/coverage-boost-2026-05-15/import-results.jsonl'
writeFileSync(log, '')
let ok=0, fail=0

...
const candidates = JSON.parse(readFileSync('scripts/seo-out/longtail-overnight-2026-05-16/candidates-batch5.json','utf8'))
...
console.log(`Batch5: ${newOnes.length} new, ${promos.length} promotions`)
...
writeFileSync('scripts/seo-out/longtail-overnight-2026-05-16/payloads-batch5.json', JSON.stringify(payloads, null, 2))

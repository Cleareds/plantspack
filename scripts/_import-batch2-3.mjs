...
const payloads = JSON.parse(readFileSync('scripts/seo-out/longtail-overnight-2026-05-16/payloads-batch2-3.json','utf8'))
const log = 'scripts/seo-out/longtail-overnight-2026-05-16/import-results-b23.jsonl'
writeFileSync(log, '')
let ok=0, fail=0

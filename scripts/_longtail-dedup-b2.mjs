...
const candidates = JSON.parse(readFileSync('scripts/seo-out/longtail-overnight-2026-05-16/candidates-batch2.json','utf8'))
...
console.log(`Batch2: ${newOnes.length} new, ${promos.length} promotions`)
...
writeFileSync('scripts/seo-out/longtail-overnight-2026-05-16/payloads-batch2.json', JSON.stringify(payloads, null, 2))
writeFileSync('scripts/seo-out/longtail-overnight-2026-05-16/promotions-batch2.json', JSON.stringify(promos, null, 2))
// Apply promotions immediately (they don't conflict with the import)

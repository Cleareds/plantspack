...
const payloads = JSON.parse(readFileSync('scripts/seo-out/longtail-overnight-2026-05-16/payloads-batch7.json','utf8'))
const log = 'scripts/seo-out/longtail-overnight-2026-05-16/import-results-b7.jsonl'
writeFileSync(log, '')
let ok=0, fail=0
